...
public class MenuEditor 
{
    ...
    public static bool CheckFirebaseJson(bool isShowOk = true)
    {
        ...
        if (files.Length == 0)
        {
            Debug.LogError("[3rdLib]==>Project doesnt contain google-services.json. Firebase may not work!!!!!<==");
            if (!EditorUtility.DisplayDialog("Oop, something wrong?",
        ...
        if (files.Length > 1)
        {
            Debug.LogError("[3rdLib]==>Project contain more than one file google-services.json. Firebase may not work wrong!!!!!<==");
            if (!EditorUtility.DisplayDialog("Oop, something wrong?",
    ...
    public static string CheckFirebaseXml()
    {
        ...
        Debug.LogError("[3rdLib]==>Project error google-services.xml. Firebase may not work wrong!!!!!<==");
        return null;
    }
    ...
    public static string Report(BuildReport report)
    {
        ...
        {
            EditorGUILayout.LabelField("[3rdLib]:Can not find GoogleMobileAdsSettings!");
        }
    ...
    static string FindCommand()
    {
        ...
        Debug.LogError("[3rdLib]==>Project dont have require .sh file. Can't auto push git!!!!!<==");
        return null;
    }
