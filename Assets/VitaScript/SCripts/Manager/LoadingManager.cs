    ...
    public class LoadingManager : Singleton<LoadingManager>
    {
        ...
        public LoadingManager Init(Action<List<bool>> onDone = null)
        {
            ...
            _loading.onValueChanged.AddListener((value) =>
            {
                if (value == 100)
                {
                    ...
                    {
                        Debug.LogError("[3rdLib]==> callback ondone loading error: " + e.ToString() + " <==");
                    }
        ...
        public void StopLoading()
        {
            ...
            if (_maxTimeLoading == 0.2f)
                return;
            Debug.Log("[3rdLib]==> Force stop loading! <==");
        ...
        public LoadingManager DoneCondition(int id)
        {
            ...
            {
                Debug.LogError("[3rdLib]==> ID condition not exist, check number of conditon on inspector! <==");
                return this;
            }

            if (_loading.value >= 99f)
            {
                Debug.LogWarning("[3rdLib]==> Loading already stop, maybe check your game flow! <==");
                return this;
            }
            ...
            {
                Debug.Log("[3rdLib]==> All condition is done! stop loading! <==");
                StopLoading();
            }
